...
public class C14Activity1 extends AppCompatActivity {
    ...
    public void insert(View view) {
        ...
        try {
            ...
            Log.e(C14Activity1.class.toString(), e.toString());
        } finally {
    ...
    public void query(View view) {
        ...
        try {
            ...
            while (cursor.moveToNext()) {
                ...
                Log.i(C14Activity1.class.toString(), "id:" + id + ",stuname:" + stuname + ",stutel:" + stutel);
            }
            cursor.close();
        } catch (Exception e) {
            Log.e(C14Activity1.class.toString(), e.toString());
